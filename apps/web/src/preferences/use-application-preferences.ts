...
const english: Record<string, string> = {
  ...
  'app.openCurrentUrlInNewTab': 'Open current URL in a new tab',
  'app.enterFullscreen': 'Enter Full Screen',
  ...
  'app.noticeDatabaseUnavailable':
    'Requested database {database} is unavailable.',
  ...
  'app.noticeFullscreenFailed': 'Unable to change full-screen mode.',
...
const traditionalChinese: Record<string, string> = {
  ...
  'app.connecting': '正在連線…',
  'app.openCurrentUrlInNewTab': '在新頁籤開啟目前網址',
  'app.enterFullscreen': '進入全螢幕',
  'app.exitFullscreen': '離開全螢幕',
  ...
  'app.noticeFullscreenFailed': '無法切換全螢幕模式。',
  'schema.database': '資料庫',
  'schema.title': 'Schema Explorer',
...
const simplifiedChinese: Record<string, string> = {
  ...
  'app.connecting': '正在连接…',
  'app.openCurrentUrlInNewTab': '在新标签页打开当前网址',
  'app.enterFullscreen': '进入全屏',
  ...
  'app.noticeJoinCreated': '已建立 JOIN：{left} = {right}。',
  'app.noticeFullscreenFailed': '无法切换全屏模式。',
  'schema.database': '数据库',
